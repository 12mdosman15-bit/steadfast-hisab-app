# -*- coding: utf-8 -*-
"""English Bangladesh District -> Thana/Upazila data for Steadfast Business.

The app keeps this data locally so the dropdown does not depend on an external
geography service. The list follows the geography set used in the previous app,
with all labels presented in English.
"""
...
# A small integrity check: the app should always expose all 64 districts.
assert len(BD_GEO) == 64, f"Expected 64 districts, got {len(BD_GEO)}"
